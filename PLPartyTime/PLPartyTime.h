 ...
 * Peter Livesey:
     ...
     Most of this is self documenting, so I'm going to leave documentation out right now...
     I'm a little tired of writing documentation for now.
 
 * Cristián Arenas:
 
     It's ok, I take it from here, go rest ;)
